...
public class DoTerminatedListsOverlap {
  ...
  public static void overlappingNoCycleListsWrapper(TestTimer timer, ListNode<Integer> p1,
      ListNode<Integer> p2, ListNode<Integer> common) throws TestFailureException {
    if (common != null) {
      if (p1 != null) {
